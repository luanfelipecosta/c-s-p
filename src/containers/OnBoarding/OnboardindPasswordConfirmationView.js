      ...
      <View style={AppStyles.container} >
        <Grid>
          <Row style={{ paddingHorizontal: 15, paddingTop: 90, flexDirection: 'column' }}>
            ...
            <Text style={[AppStyles.sceneTitle, AppStyles.lightText, { alignSelf: 'center', textAlign: 'center' }]}> Confirme a senha que você criou</Text>
            <Text style={[AppStyles.sceneTitle, AppStyles.lightText, { alignSelf: 'center', textAlign: 'center' }]}> As senhas devem ser iguais</Text>
          ...
          <Row style={{ height: 64 }}>
            <StepNavigation
              ...
              nextStep={() => Actions.onBoardingAccountCreated()}
            />
          </Row>
          <KeyboardSpacer />
        </Grid>
