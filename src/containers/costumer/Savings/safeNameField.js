...
const SafeNameField = ({ step, prevStep, nextStep }) => (
  <View style={styles.container} >
    <View style={styles.formTitle}>
      <Spacer size={60} />
      <Text style={styles.title}> Primeiro, de um nome para o cofrinho que você está criando </Text>
      <Spacer size={30} />
    </View>
    <View style={styles.formField}>
      <FormLabel labelStyle={{ fontWeight: '200' }}>Nome do cofrinho: </FormLabel>
